    ...
    var __webpack_modules__ = [
        ...
        (__unused_webpack_module, exports, __w_pdfjs_require__) => {
          ...
          function getDocument(t) {
            if ("string" == typeof t || t instanceof URL) t = { url: t };
            else if ((0, _util.isArrayBuffer)(t)) t = { data: t };
            else if (t instanceof PDFDataRangeTransport) {
            ...
            const e = new PDFDocumentLoadingTask(),
              ...
              i = t.httpHeaders || null,
              a = !0 === t.withCredentials,
              r = t.password ?? null,
              o = t.range instanceof PDFDataRangeTransport ? t.range : null,
              l =
            ...
            const h = t.verbosity,
              d =
                ...
                (0, _display_utils.isDataScheme)(t.docBaseUrl)
                  ? null
                  : t.docBaseUrl,
              u = "string" == typeof t.cMapUrl ? t.cMapUrl : null,
              p = !1 !== t.cMapPacked,
              ...
              f =
                "string" == typeof t.standardFontDataUrl
                  ...
                  : null,
              m = t.StandardFontDataFactory || DefaultStandardFontDataFactory,
              b = !0 !== t.stopAtErrors,
              A =
              ...
              M =
                "boolean" == typeof t.useWorkerFetch
                  ...
                  : g === _display_utils.DOMCMapReaderFactory &&
                    m === _display_utils.DOMStandardFontDataFactory &&
                    (0, _display_utils.isValidFetchUrl)(u, document.baseURI) &&
                    (0, _display_utils.isValidFetchUrl)(f, document.baseURI);
            (0, _util.setVerbosityLevel)(h);
            const F = M
              ? null
              : {
                  cMapReaderFactory: new g({ baseUrl: u, isCompressed: p }),
                  standardFontDataFactory: new m({ baseUrl: f }),
                };
            if (!c) {
              const t = {
                verbosity: h,
            ...
            c.promise
              .then(function () {
                ...
                return Promise.all([t, r]).then(function ([t, s]) {
                  if (e.destroyed) throw new Error("Loading aborted");
                  const n = new _message_handler.MessageHandler(D, t, c.port),
                    i = new WorkerTransport(n, e, s, O, F);
                  e._transport = i;
                  n.send("Ready", null);
                });
              })
        ...
        (t, e, s) => {
          ...
          class PrintAnnotationStorage extends AnnotationStorage {
            ...
            constructor(t) {
              super();
              this.#m = structuredClone(t.serializable);
            }
            get print() {
              (0, n.unreachable)(
        ...
        (t, e, s) => {
          ...
          class AnnotationEditorUIManager {
            ...
            destroy() {
              ...
              for (const t of this.#M.values()) t.destroy();
              this.#M.clear();
              this.#R.clear();
              this.#L.clear();
              this.#k = null;
            ...
            addLayer(t) {
              this.#M.set(t.pageIndex, t);
              this.#U ? t.enable() : t.disable();
            }
            removeLayer(t) {
              this.#M.delete(t.pageIndex);
            }
            updateMode(t) {
              this.#B = t;
              if (t === n.AnnotationEditorType.NONE) {
                ...
                this.#lt();
                for (const e of this.#M.values()) e.updateMode(t);
              }
            }
            updateToolbar(t) {
              t !== this.#B &&
            ...
            #lt() {
              if (!this.#U) {
                this.#U = !0;
                for (const t of this.#M.values()) t.enable();
              }
            }
            #ot() {
              this.unselectAll();
              if (this.#U) {
                this.#U = !1;
                for (const t of this.#M.values()) t.disable();
              }
            }
            getEditors(t) {
              const e = [];
              for (const s of this.#R.values()) s.pageIndex === t && e.push(s);
              return e;
            }
            getEditor(t) {
              return this.#R.get(t);
            ...
            #st(t) {
              const e = this.#M.get(t.pageIndex);
            ...
            #rt() {
              ...
              if (1 === this.#R.size)
                for (const t of this.#R.values()) return t.isEmpty();
              return !1;
            }
            delete() {
              this.commitOrRemove();
        ...
        (t, e, s) => {
          ...
          function drawImageAtIntegerCoords(t, e, s, n, a, r, o, l, c, h) {
            const [d, u, p, g, f, m] = (0, i.getCurrentTransform)(t);
            if (0 === u && 0 === p) {
              const i = o * d + f,
                b = Math.round(i),
                A = l * g + m,
          ...
          function putBinaryImageData(t, e, s = null) {
            ...
            if (e.kind === n.ImageKind.GRAYSCALE_1BPP) {
              const e = p.byteLength,
                ...
                A = (a + 7) >> 3;
              let _ = 4294967295,
                v = n.FeatureTest.isLittleEndian ? 4278190080 : 255;
          ...
          function putBinaryImageMask(t, e) {
            ...
            for (let e = 0; e < o; e++) {
              const s = e < a ? c : i;
              ({ srcPos: h } = (0, r.applyMaskImageData)({
                src: d,
                srcPos: h,
                dest: u,
                width: n,
          ...
          class CanvasGraphics {
            ...
            _createMaskCanvas(t) {
              ...
              const f = n.Util.applyTransform([0, 0], g),
                m = n.Util.applyTransform([s, r], g),
                b = n.Util.normalizeRect([f[0], f[1], m[0], m[1]]),
              ...
              if (!u) {
                u = this._scaleImage(
                  p.canvas,
                  (0, i.getCurrentTransformInverse)(y)
                );
                u = u.img;
                h && l && h.set(d, u);
              }
              y.imageSmoothingEnabled = getImageSmoothingEnabled(
                (0, i.getCurrentTransform)(y),
                t.interpolate
              );
              ...
              const E = n.Util.transform((0, i.getCurrentTransformInverse)(y), [
                1,
                0,
                0,
                1,
              ...
              y.fillStyle = l ? o.getPattern(e, this, E, a.PathType.FILL) : o;
              y.fillRect(0, 0, s, r);
              if (h && !l) {
                ...
                switch (0 | t[s]) {
                  case n.OPS.rectangle:
                    ...
                    const t = e[i++],
                      ...
                      f = h + s;
                    a.moveTo(c, h);
                    if (0 === t || 0 === s) a.lineTo(g, f);
                    else {
                      a.lineTo(g, h);
                      a.lineTo(g, f);
                      a.lineTo(c, f);
                    }
                    u || r.updateRectMinMax(d, [c, h, g, f]);
                    a.closePath();
                    break;
                  case n.OPS.moveTo:
                    c = e[i++];
            ...
            showType3Text(t) {
              ...
              if (
                ...
                for (p = 0; p < u; ++p) {
                  ...
                  f = n.Util.applyTransform([g.width, 0], d)[0] * a + r;
                  e.translate(f, 0);
                  s.x += f * h;
                }
                e.restore();
            ...
            beginGroup(t) {
              ...
              const l = Math.floor(a[0]),
                c = Math.floor(a[1]);
              let h = Math.max(Math.ceil(a[2]) - l, 1),
        ...
        (t, e, s) => {
          ...
          function drawTriangle(t, e, s, n, i, a, r, o) {
            ...
            for (let t = w; t <= k; t++) {
              ...
              L = v - (v - P) * e;
              N = y - (y - T) * e;
              const s = Math.round(Math.min(R, I)),
                n = Math.round(Math.max(R, I));
              let i = d * t + 4 * s;
              for (let t = s; t <= n; t++) {
                e = (R - t) / (R - I);
                e < 0 ? (e = 0) : e > 1 && (e = 1);
            ...
            setFillAndStrokeStyleToContext(t, e, s) {
              ...
              switch (e) {
                case r:
                  ...
                  break;
                case o:
                  const l = n.Util.makeHexColor(s[0], s[1], s[2]);
                  i.fillStyle = l;
                  i.strokeStyle = l;
                  a.fillColor = l;
                  a.strokeColor = l;
        ...
        (t, e, s) => {
          ...
          e.PDFDataTransportStream = class PDFDataTransportStream {
            constructor(
              ...
              this._contentDispositionFilename = i;
              if (e?.length > 0) {
                const t =
        ...
        (t, e, s) => {
          ...
          function appendText(t, e, s) {
            ...
            t._textDivs.push(i);
            const c = n.Util.transform(t._transform, e.transform);
              ...
              p =
                ...
                (function getAscent(t, e) {
                  ...
                  let a = i.fontBoundingBoxAscent,
                    c = Math.abs(i.fontBoundingBoxDescent);
                  if (a) {
                    const e = a / (a + c);
                    l.set(t, e);
                  ...
                  n.clearRect(0, 0, r, r);
                  n.strokeText("g", 0, 0);
                  let h = n.getImageData(0, 0, r, r).data;
                  c = 0;
                  ...
                  n.clearRect(0, 0, r, r);
                  n.strokeText("A", 0, r);
                  h = n.getImageData(0, 0, r, r).data;
                  a = 0;
                  for (let t = 0, e = h.length; t < e; t += 4)
                    if (h[t] > 0) {
                      a = r - Math.floor(t / 4 / r);
                      break;
                    }
                  n.canvas.width = n.canvas.height = 0;
                  if (a) {
            ...
            if (t._container === t._rootContainer) {
              ...
              b.top = `${((100 * f) / t._pageHeight).toFixed(2)}%`;
            } else {
              b.left = `${m}${g.toFixed(2)}px)`;
              b.top = `${m}${f.toFixed(2)}px)`;
            }
            ...
            A && (a.canvasWidth = d.vertical ? e.height : e.width);
        ...
        (t, e, s) => {
          ...
          class AnnotationEditorLayer {
            #At;
            #_t = !1;
            #vt = this.pointerup.bind(this);
            #yt = this.pointerdown.bind(this);
            #St = new Map();
            #xt = !1;
            #Et = !1;
            #Ct;
            ...
            enableClick() {
              this.div.addEventListener("pointerdown", this.#yt);
              this.div.addEventListener("pointerup", this.#vt);
            }
            disableClick() {
              this.div.removeEventListener("pointerdown", this.#yt);
              this.div.removeEventListener("pointerup", this.#vt);
            }
            attach(t) {
              this.#St.set(t.id, t);
            }
        ...
        (t, e, s) => {
          ...
          class FreeTextEditor extends a.AnnotationEditor {
            #Rt = this.editorDivBlur.bind(this);
            #Mt = this.editorDivFocus.bind(this);
            #Ft = this.editorDivInput.bind(this);
            ...
            enableEditMode() {
              if (!this.isInEditMode()) {
                ...
                this.editorDiv.addEventListener("focus", this.#Mt);
                this.editorDiv.addEventListener("blur", this.#Rt);
            ...
            disableEditMode() {
              if (this.isInEditMode()) {
                ...
                this.editorDiv.removeEventListener("focus", this.#Mt);
                this.editorDiv.removeEventListener("blur", this.#Rt);
          ...
          function generateAndReport(t, e, s, n, i, a) {
            ...
            r = (function generateBezier(t, e, s, n) {
              ...
              for (m = 0, b = e.length; m < b; m++) {
                v = 1 - (_ = e[m]);
                (r = a[m])[0] = maths.mulItems(s, 3 * _ * (v * v));
                r[1] = maths.mulItems(n, 3 * v * (_ * _));
              }
              o = [
                [0, 0],
                [0, 0],
              ...
              for (m = 0, b = t.length; m < b; m++) {
                ...
                A = maths.subtract(t[m], bezier.q([y, y, S, S], _));
                l[0] += maths.dot(r[0], A);
                l[1] += maths.dot(r[1], A);
              }
              ...
              u = 0 === c ? 0 : d / c;
              p = 0 === c ? 0 : h / c;
              f = maths.vectorLen(maths.subtract(y, S));
              if (u < (g = 1e-6 * f) || p < g) {
                i[1] = maths.addArrays(y, maths.mulItems(s, f / 3));
                i[2] = maths.addArrays(S, maths.mulItems(n, f / 3));
              } else {
                i[1] = maths.addArrays(y, maths.mulItems(s, u));
          ...
          e.SVGGraphics = r;
          {
            const o = {
              ...
              u = (function () {
                ...
                function writePngChunk(t, e, n, i) {
                  let a = i;
                  const r = e.length;
                  n[a] = (r >> 24) & 255;
                  n[a + 1] = (r >> 16) & 255;
                ...
                function encode(s, n, r, o) {
                  ...
                  const g = new Uint8Array((1 + u) * c);
                  let f = 0,
                    m = 0;
                  for (let t = 0; t < c; ++t) {
                    g[f++] = 0;
                    g.set(p.subarray(m, m + u), f);
                    m += u;
                    f += u;
                  }
                  ...
                  const b = new Uint8Array([
                    ...
                    _ = t.length + 3 * e + b.length + A.length,
                    v = new Uint8Array(_);
                  let y = 0;
                  v.set(t, y);
                  y += t.length;
                  writePngChunk("IHDR", b, v, y);
                  y += e + b.length;
                  writePngChunk("IDATA", A, v, y);
                  y += e + A.length;
                  writePngChunk("IEND", new Uint8Array(0), v, y);
                  return createObjectURL(v, "image/png", r);
                }
